...
export const IncomingCallModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[var(--z-modal)] flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-900/95 via-purple-900/90 to-indigo-900/95 backdrop-blur-md" />
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-8">
                ...
                <div className="relative mb-8">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 animate-pulse blur-xl opacity-50" />
                    {incomingCall.callerAvatar ? (
                        ...
                        <div className="relative w-32 h-32 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center border-4 border-white/20 shadow-2xl">
                ...
                <div className="flex items-center gap-8">
                    ...
                    >
                        ...
                        <span className="mt-3 text-sm text-white/60 font-medium">Decline</span>
                    </button>
                    ...
                    <button
                        ...
                        className="group relative flex flex-col items-center"
                    >
                        <div className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-green-500/40 animate-pulse">
                            <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                        </div>
                        <span className="mt-3 text-sm text-white/60 font-medium">Accept</span>
                    </button>
                </div>
            </div>
        </div>
