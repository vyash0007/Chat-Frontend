  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-[var(--divider-color)]">
        <button
          className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-[var(--accent-primary)] text-white rounded-lg hover:bg-[var(--accent-hover)] transition-colors font-medium"
          onClick={() => {
